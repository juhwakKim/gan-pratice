...
class RandomWeightedAverage(_Merge):
    ...
    def _merge_function(self, inputs):
        alpha = K.random_uniform((32,64, 2))
...
class WGANGP():
    ...
    def build_generator(self):
        ...
        model = Sequential()
        '''
        model.add(Dense(16 * 256, activation="relu", input_dim=self.latent_dim))
        ...
        model.add(BatchNormalization(momentum=0.8))
        model.add(Activation("relu"))
        model.add(Conv1D(2, kernel_size=4, padding="same"))
        model.add(Activation("sigmoid"))
        '''
        model.add(Dense(64 * 128, activation="relu", input_dim=self.latent_dim))
        model.add(Reshape((64, 128)))
        model.add(CuDNNLSTM(128, input_shape=(64,128), return_sequences=True))
    ...
    def build_critic(self):
        ...
        model.add(Conv1D(16, kernel_size=3, strides=2, input_shape=(64,2), padding="same"))
