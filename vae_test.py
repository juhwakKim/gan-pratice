...
x = Conv1DTranspose(x, 256, 5, trainable=True, padding='SAME',name="deconv_decoder_1")
x = BatchNormalization()(x)
x = Activation('relu')(x)
x = Conv1DTranspose(x, 128, 5, trainable=True, padding='SAME',name="deconv_decoder_2")
x = BatchNormalization()(x)
x = Activation('relu')(x)
x = Conv1DTranspose(x, 64, 5, trainable=True, padding='SAME',name="deconv_decoder_3")
x = BatchNormalization()(x)
x = Activation('relu')(x)
x = Conv1DTranspose(x, 32, 5, trainable=True, padding='SAME',name="deconv_decoder_4")
x = BatchNormalization()(x)
x = Activation('relu')(x)
x = Conv1DTranspose(x, 2, 5, trainable=True, padding='SAME',name="deconv_decoder_5")
x = Activation('relu')(x)
...
n = 15
decoder.load_weights("model_1.h5")

grid_x = norm.ppf(np.linspace(0.05, 0.95, n))
grid_y = norm.ppf(np.linspace(0.05, 0.95, n))
z_sample = np.random.randn(150,64) * 100
print(z_sample)
